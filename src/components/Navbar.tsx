        ...
        <div className='bg-gradient-to-b from-black to-gray-800 text-white h-[4rem] px-10 pb-10 py-6 w-full fixed top-0 left-0 z-50'>
            <div className='flex justify-between'>
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ delay: 0.3, duration: 2 }}
                    className='max-[1500px]:block hidden'
                >
                ...
                <div className='max-[1500px]:hidden block'>
                    <NavBarLi />
                </div>
            </div>
            ...
            <AnimatePresence>
                {show && (
                    <motion.div
                        ...
                        className='max-[1500px]:block hidden h-screen bg-gray-800 text-white absolute w-full top-[4rem] right-0'
                    >
